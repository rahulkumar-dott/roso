  ...
  return (
    <html lang="en" className="h-full antialiased font-sans">
      <body className="min-h-full flex flex-col bg-white text-brand-navy">
        ...
        <header className="border-b border-slate-200 bg-white">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <nav className="hidden items-center gap-8 text-sm font-medium text-brand-navy/80 sm:flex">
              ...
              <span className="cursor-default text-brand-navy/40">About Us</span>
              <span className="cursor-default text-brand-navy/40">Trip Ideas</span>
              <span className="cursor-default text-brand-navy/40">Contact</span>
        ...
        <footer className="border-t border-slate-200 bg-brand-navy py-8 text-center text-sm text-white/70">
